...
def track(x,s):
  ...
  cz = np.zeros(2*l2cm.code_length)
  cz[0:2*l2cm.code_length:2] = c

  p_early = l2cm.correlate(x, s.prn, 0, s.code_p-0.5, cf, cz)
  p_prompt = l2cm.correlate(x, s.prn, 0, s.code_p, cf, cz)
  p_late = l2cm.correlate(x, s.prn, 0, s.code_p+0.5, cf, cz)
