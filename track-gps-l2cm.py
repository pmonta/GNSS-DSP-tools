...
# example:
#   ./track-gps-l2cm.py /dev/stdin 68873142.857 -12116571.429 31 -620 141.2
...
while True:
  ...
  for j in range(20):
    ...
    print block,np.real(p_prompt),np.imag(p_prompt),s.carrier_f,s.code_f-l2cm.chip_rate,(180/np.pi)*np.angle(p_prompt)
