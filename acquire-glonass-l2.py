...
parser = optparse.OptionParser(usage="""acquire-glonass-l2.py [options] input_filename sample_rate carrier_offset

Acquire GLONASS L2 signals

Examples:
  Acquire all GLONASS channels using standard input with sample rate 69.984 MHz and carrier (channel 0) offset 18.272874 MHz:
...
fsr = 16384000.0/fs
h = scipy.signal.firwin(161,6e6/(fs/2),window='hann')
