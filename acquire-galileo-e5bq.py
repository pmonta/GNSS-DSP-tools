...
parser = optparse.OptionParser(usage="""acquire-galileo-e5bq.py [options] input_filename sample_rate carrier_offset

Acquire Galileo E5bq signals

Examples:
  Acquire all Galileo PRNs using standard input with sample rate 69.984 MHz and carrier offset 15.498375 MHz:
    acquire-galileo-e5bq.py /dev/stdin 69984000 15498375
