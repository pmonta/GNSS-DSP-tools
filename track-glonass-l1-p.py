...
parser = optparse.OptionParser(usage="""track-glonass-l1-p.py [options] input_filename sample_rate carrier_offset chan doppler code_offset

Track GLONASS L1 P signal

Examples:
  Track with default options:
    track-glonass-l1-p.py /dev/stdin 69984000 17245125 4 1200.0 1841430.6
  Track with pure PLL (no FLL intervals at the start) and with a specified carrier phase:
    track-glonass-l1-p.py --carrier-phase 0.214 /dev/stdin 69984000 17245125 4 1200.0 1841430.6
