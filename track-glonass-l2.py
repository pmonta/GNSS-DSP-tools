...
parser = optparse.OptionParser(usage="""track-glonass-l2.py [options] input_filename sample_rate carrier_offset chan doppler code_offset

Track GLONASS L2 C/A signal

Examples:
  Track with default options:
    track-glonass-l2.py /dev/stdin 69984000 18272874 4 1200.0 381.1
  Track with pure PLL (no FLL intervals at the start) and with a specified carrier phase:
    track-glonass-l2.py --carrier-phase 0.214 /dev/stdin 69984000 18272874 4 1200.0 381.1
