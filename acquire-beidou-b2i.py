...
parser = optparse.OptionParser(usage="""acquire-beidou-b2i.py [options] input_filename sample_rate carrier_offset

Acquire BeiDou B2I signals

Examples:
  Acquire all BeiDou PRNs using standard input with sample rate 69.984 MHz and carrier offset -20.587126 MHz:
    acquire-beidou-b2i.py /dev/stdin 69984000 -20587126
...
fsr = 8192000.0/fs
h = scipy.signal.firwin(161,3e6/(fs/2),window='hann')
