...
def search(x,prn):
  ...
  c = l5q.code(prn,0,0,incr,n)                     # obtain samples of the E5b-I code
...
# example:
#   ./acquire-gps-l5q.py /dev/stdin 68873142.857 5606571.429

filename = sys.argv[1]        # input data, raw file, i/q interleaved, 8 bit signed (two's complement)
fs = float(sys.argv[2])       # sampling rate, Hz
coffset = float(sys.argv[3])  # offset to L5 GPS carrier, Hz (positive or negative)
