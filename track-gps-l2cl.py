...
parser = optparse.OptionParser(usage="""track-gps-l2cl.py [options] input_filename sample_rate carrier_offset PRN doppler code_offset

Track GPS L2CL signal

Examples:
  Track with default options:
    track-gps-l2cl.py /dev/stdin 69984000 -127126 31 1200.0 831.15
  Track with pure PLL (no FLL intervals at the start) and with a specified carrier phase:
    track-gps-l2cl.py --carrier-phase 0.214 /dev/stdin 69984000 -127126 31 1200.0 831.15
