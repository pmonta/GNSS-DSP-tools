...
parser = optparse.OptionParser(usage="""track-beidou-b1i.py [options] input_filename sample_rate carrier_offset PRN doppler code_offset

Track BeiDou B1I signal

Examples:
  Track with default options:
    track-beidou-b1i.py /dev/stdin 69984000 -23656875 31 1200.0 831.15
  Track with pure PLL (no FLL intervals at the start) and with a specified carrier phase:
    track-beidou-b1i.py --carrier-phase 0.214 /dev/stdin 69984000 -23656875 31 1200.0 831.15
