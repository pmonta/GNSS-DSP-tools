...
parser = optparse.OptionParser(usage="""acquire-galileo-e1b.py [options] input_filename sample_rate carrier_offset

Acquire Galileo E1B signals

Examples:
  Acquire all Galileo PRNs using standard input with sample rate 69.984 MHz and carrier offset -9.334875 MHz:
    acquire-gps-e1b.py /dev/stdin 69984000 -9334875
