...
# example:
#   ./track-galileo-e5bq.py /dev/stdin 68873142.857 -8662285.714 12 -350 1274.2
...
while True:
  ...
  print block, np.real(p_prompt), np.imag(p_prompt), s.carrier_f, s.code_f-e5bq.chip_rate, (180/np.pi)*np.angle(p_prompt), s.early, s.prompt, s.late
