...
parser = optparse.OptionParser(usage="""track-galileo-e1b.py [options] input_filename sample_rate carrier_offset PRN doppler code_offset

Track Galileo E1B signal

Examples:
  Track with default options:
    track-galileo-e1b.py /dev/stdin 69984000 -9334875 31 1200.0 831.15
  Track with pure PLL (no FLL intervals at the start) and with a specified carrier phase:
    track-galileo-e1b.py --carrier-phase 0.214 /dev/stdin 69984000 -9334875 31 1200.0 831.15
